...
const Endangered = () => {
  // Changed from Critically_Endangered to Endangered
  ...
  const speciesData = [
    {
      scientificName: "Melanochelys tricarinata",
      commonName: "Three-keeled Turtle",
      image: melanochelys,
    },
    {
      scientificName: "Eutropis clivicola",
      commonName: "Jerdon's Smooth Lizard",
      image: eutropis,
    },
    {
      scientificName: "Dasia subcaerulea",
      commonName: "Blue-tailed Skink",
      image: dasia,
    },
    {
      scientificName: "Cnemaspis goaensis",
      commonName: "Goa Gecko",
      image: cnemaspisGoaensis,
    },
    {
      scientificName: "Cnemaspis wynadensis",
      commonName: "Wayanad Gecko",
      image: cnemaspisWynadensis,
    },
    {
    ...
    {
      scientificName: "Rhinophis travancoricus",
      commonName: "Shield-tailed Snake",
      image: rhinophis,
    },
    {
      scientificName: "Eurylepis poonaensis",
      commonName: "Poona Lizard",
      image: eurylepis,
    },
    {
      scientificName: "Otocryptis beddomii",
      commonName: "Flap-necked Lizard",
      image: otocryptis,
    },
    {
      scientificName: "Hemidactylus scabriceps",
      commonName: "Termite Gecko",
      image: hemidactylus,
    },
  ];
